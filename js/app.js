...
const affiliateImg   = $("affiliateImg");
...
const AFF = {
  omikamo: {
    ...
    imgUrl: "./img/rec/mobile_fold.webp" // 自前画像
  },
  elecom: {
    ...
    imgUrl: "./img/rec/pc_keyboard.webp" // 自前画像
  }
};

// 既存の isMobileDevice() を使う（あなたのapp.jsに既にある）
function pickAffiliateProduct() {
  return isMobileDevice() ? AFF.omikamo : AFF.elecom;
}

function renderAffiliate() {
  const affiliateBox   = document.getElementById("affiliateBox");
  const affiliateLead  = document.getElementById("affiliateLead");
  const affiliateLink  = document.getElementById("affiliateLink");
  const affiliateTitle = document.getElementById("affiliateTitle");
  const affiliateNote  = document.getElementById("affiliateNote");
  const affiliateImg   = document.getElementById("affiliateImg");
  if (!affiliateBox || !affiliateLead || !affiliateLink || !affiliateTitle || !affiliateNote || !affiliateImg) return;
  ...
  affiliateImg.src = p.imgUrl;  // 自前画像
  affiliateImg.alt = p.title;
  affiliateImg.loading = "lazy";
  affiliateImg.decoding = "async";
